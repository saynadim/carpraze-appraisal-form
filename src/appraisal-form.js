...
(function () {
  ...
  function getConfigFromMeta() {
    ...
    const formType = document.querySelector('meta[name="carprazeForm:formType"]');

    return {
      token: tokenMeta && tokenMeta.getAttribute('content'),
      selector: selectorMeta && selectorMeta.getAttribute('content'),
      formType: formType && formType.getAttribute('content')
    };
  }
  ...
  function initContactForm() {
    ...
    var formType = carprazeForm.formType || 'customerInput';
